...
$(document).ready(function()
{
	...
	$('tr').has('div[id=errorRateScore]').find('input').val((($('tr').has('div[id=averageErrorRate]').find('input').val() / $('tr').has('div[id=expectedErrorRate]').find('input').val()).toFixed(1)) * 100 + '%');
	$('tr').has('div[id=lateDocumentationRateScore]').find('input').val((($('tr').has('div[id=averageLateDocumentationRate]').find('input').val() / $('tr').has('div[id=expectedLateDocumentationRate]').find('input').val()).toFixed(1)) * 100 + '%');
